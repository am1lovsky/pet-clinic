...
class ClinicServiceTests {
	...
	@Test
	void shouldReturnTrueIfMoreThen5VisitsByVetIn7Days() {
		Vet vet = new Vet();
		vet.setId(1);
	...
	@Test
	void shouldReturnFalseIfNotMoreThen5VisitsByVetIn7Days() {
		Vet vet = new Vet();
		vet.setId(1);
		LocalDate sevenDaysAgo = LocalDate.now().minusDays(7);
	...
	void shouldReturnWorkloadWithVisitCountAndOverloadedFlag() {
		...
		given(visitRepository.countByVetIdAndDateGreaterThanEqual(vet.getId(), sevenDays)).willReturn(6L);
